  ...
  return (
    <motion.article whileHover={{ x: 3 }} transition={{ duration: 0.16 }}>
      <Link
        ...
        className="soft-border group relative grid min-h-[88px] grid-cols-[100px_minmax(0,1fr)] overflow-hidden rounded-lg bg-white/[0.035] transition hover:border-teal-300/35 hover:bg-white/[0.06] sm:min-h-[96px] sm:grid-cols-[140px_minmax(0,1fr)]"
      >
        {episode.isFree ? (
        ...
        <div className="relative h-full min-h-[88px] w-full overflow-hidden bg-white/[0.04] sm:min-h-[96px]">
          <Image src={episode.thumbnail || episode.poster} alt="" fill className="object-cover" sizes="(max-width: 640px) 112px, 140px" />
